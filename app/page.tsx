  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="bg-gradient-to-r from-orange-500 via-teal-600 to-emerald-600 text-white shadow-lg sticky top-0 z-50">
        ...
        {/* Mobile Menu */}
        {mobileOpen && (
          <div className="md:hidden bg-gradient-to-r from-orange-600 via-teal-700 to-emerald-700 text-white">
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-teal-900 to-emerald-900">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Features Icons */}
            <div className="mt-10 sm:mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 opacity-70 px-2">
              <div className="text-center">
                <div className="w-10 sm:w-12 h-10 sm:h-12 mx-auto mb-2 sm:mb-3 bg-gradient-to-br from-orange-500/20 to-orange-600/20 rounded-lg flex items-center justify-center border border-orange-400/30">
                  <svg className="w-5 sm:w-6 h-5 sm:h-6 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                </div>
                <p className="text-orange-300 text-xs sm:text-sm font-medium">Innovation</p>
              </div>
              
              <div className="text-center">
                <div className="w-10 sm:w-12 h-10 sm:h-12 mx-auto mb-2 sm:mb-3 bg-gradient-to-br from-teal-500/20 to-teal-600/20 rounded-lg flex items-center justify-center border border-teal-400/30">
                  <svg className="w-5 sm:w-6 h-5 sm:h-6 text-teal-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                </div>
                <p className="text-teal-300 text-xs sm:text-sm font-medium">Performance</p>
              </div>
              
              <div className="text-center">
                <div className="w-10 sm:w-12 h-10 sm:h-12 mx-auto mb-2 sm:mb-3 bg-gradient-to-br from-emerald-500/20 to-emerald-600/20 rounded-lg flex items-center justify-center border border-emerald-400/30">
                  <svg className="w-5 sm:w-6 h-5 sm:h-6 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9v-9m0-9v9" />
                  </svg>
                </div>
                <p className="text-emerald-300 text-xs sm:text-sm font-medium">Global</p>
              </div>
              
              <div className="text-center">
                <div className="w-10 sm:w-12 h-10 sm:h-12 mx-auto mb-2 sm:mb-3 bg-gradient-to-br from-orange-500/20 via-teal-500/20 to-emerald-500/20 rounded-lg flex items-center justify-center border border-orange-400/30">
                  <svg className="w-5 sm:w-6 h-5 sm:h-6 text-orange-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                </div>
                <p className="text-orange-300 text-xs sm:text-sm font-medium">Excellence</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Company Section */}
      <section id="about" className="py-12 sm:py-20 bg-gray-50 px-4">
      ...
      {/* Services Preview */}
      <section id="solutions" className="py-12 sm:py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 border-l-4 border-orange-500">
              <div className="text-center">
                <div className="w-14 sm:w-16 h-14 sm:h-16 mx-auto mb-4 bg-gradient-to-br from-orange-100 to-orange-200 rounded-lg flex items-center justify-center">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">Advanced Engineering</h3>
                <p className="text-sm sm:text-base text-gray-600">Cutting-edge solutions for complex engineering challenges with SEMHYS innovation</p>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 border-l-4 border-teal-600">
              <div className="text-center">
                <div className="w-14 sm:w-16 h-14 sm:h-16 mx-auto mb-4 bg-gradient-to-br from-teal-100 to-teal-200 rounded-lg flex items-center justify-center">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">Digital Solutions</h3>
                <p className="text-sm sm:text-base text-gray-600">Technology-driven approaches to optimize performance and efficiency</p>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 border-l-4 border-emerald-600">
              <div className="text-center">
                <div className="w-14 sm:w-16 h-14 sm:h-16 mx-auto mb-4 bg-gradient-to-br from-emerald-100 to-emerald-200 rounded-lg flex items-center justify-center">
                  <svg className="w-7 sm:w-8 h-7 sm:h-8 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9v-9m0-9v9" />
                  </svg>
                </div>
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">Global Impact</h3>
                <p className="text-sm sm:text-base text-gray-600">International engineering solutions with sustainable and scalable results</p>
              </div>
            </div>
          </div>
        </div>
